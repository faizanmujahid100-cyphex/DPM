...
import { Printer, Eye, EyeOff, Globe, ShoppingBag, Star, Zap, Package, ArrowLeft } from 'lucide-react'
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-violet-950 via-purple-900 to-slate-900 items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <p className="text-violet-300 text-lg leading-relaxed">
            Create your free account and start ordering custom prints today.
          </p>
          <div className="mt-10 space-y-3">
            {[
              { icon: ShoppingBag, text: 'Order tracking dashboard' },
              { icon: Star, text: 'Exclusive member discounts' },
              { icon: Zap, text: 'Fast reordering of past prints' },
              { icon: Package, text: 'Real-time designer updates' },
            ].map(({ icon: Icon, text }) => (
              <div key={text} className="flex items-center gap-3 bg-white/10 rounded-xl px-5 py-3 backdrop-blur-sm border border-white/15 text-white text-sm">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white overflow-y-auto">
        <div className="w-full max-w-md py-8">
          <div className="mb-8">
            ...
            <p className="text-gray-500">Join DPM Printing Center as a customer</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-white py-5 font-semibold text-base shadow-lg"
            >
          ...
          <Button
            ...
            className="w-full py-5 font-medium border-gray-200 hover:bg-gray-50 gap-2"
          >
