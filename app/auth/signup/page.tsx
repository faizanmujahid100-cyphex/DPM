...
import { Printer, Eye, EyeOff, ShoppingBag, Star, Zap, Package, ArrowLeft } from 'lucide-react'
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white overflow-y-auto">
        <div className="w-full max-w-md py-8">
          ...
          <Button
            ...
            className="w-full py-5 font-medium border-gray-200 hover:bg-gray-50 gap-3"
          >
            {googleLoading ? (
